...
if(isset($_POST['order_id']))
{
    ...
    ?>
    <p class="col-md-12 pt-4 pb-4 mb-2 text-center text-white bg-danger h3"><?php echo "Order Id: ".$order_id; ?></p>
    <?php 
    while($row=mysql_fetch_assoc($order_info_result))
    {
        ...
        <div class="col-md-12 p-2 m-2">
            ...
            <div class="col-md-12 mt-2 mb-2"><?php echo $row['extra_instruction'];?></div>
        </div>        
...
<?php
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3 p-0 m-0 float-left">
            <p><?php echo round($total_sum)." TK"; ?></p>
        </div>
        ...
        <div class="col-md-3 p-0 m-0 float-left">
            <p><?php echo round($total_sd)." TK"; ?></p>
        </div>
        <div class="col-md-9 p-0 m-0 float-left">
        <p align="right">VAT (10%) <span class="m-2"> = </span></p>
        </div>
        <div class="col-md-3 p-0 m-0 float-left">
            <p><?php echo round($total_vat)." TK"; ?></p>
        </div>        
        <div class="col-md-12">
            <hr>
        </div>
