...
if (isset($_POST['phone_number']) && isset($_POST['agent']) && isset($_POST['additional_phone']) && isset($_POST['address'])) 
{
	...
	$result_billing_address=mysql_query("INSERT INTO `billing_address`(`order_id`, `address`, `name`, `phone`, `additional_phone`) VALUES ('$order_id','$address','$customer_name','$phone_number','$additional_phone')");
