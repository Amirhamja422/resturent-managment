...
if (isset($_POST['search_result'])) 
{
	...
	if ($select_type=="all")
	{
		$sql_search="SELECT order_id, `brand`, `branch`, `phone`, `order_status`, `agent`, `order_status`, `address`, `additional_phone`, `cart_time`,`last_update_time` FROM `order` WHERE `cart_time`>='$start_date 00:00:01' AND `cart_time`<='$end_date 23:59:59' GROUP BY `order_id` ORDER BY `id` DESC";
	}
	elseif ($select_type=="order_no") 
	{
		$sql_search="SELECT `order_id`, `brand`, `branch`, `phone`, `order_status`, `agent`, `order_status`, `address`, `additional_phone`, `cart_time`,`last_update_time` FROM `order` WHERE  `order_id` LIKE '%".$search_key."%' AND `cart_time`>='$start_date 00:00:01' AND `cart_time`<='$end_date 23:59:59' GROUP BY `order_id` ORDER BY `id` DESC";
	}
	elseif ($select_type=="brand") 
	{
		$sql_search="SELECT `order_id`, `brand`, `branch`, `phone`, `order_status`, `agent`, `order_status`, `address`, `additional_phone`, `cart_time`,`last_update_time` FROM `order` WHERE  `brand`='$search_key' AND `cart_time`>='$start_date 00:00:01' AND `cart_time`<='$end_date 23:59:59' GROUP BY `order_id` ORDER BY `id` DESC";

	}
	elseif ($select_type=="branch") 
	{
		$sql_search="SELECT `order_id`, `brand`, `branch`, `phone`, `order_status`, `agent`, `order_status`, `address`, `additional_phone`, `cart_time`,`last_update_time` FROM `order` WHERE `branch`='$search_key' AND `cart_time`>='$start_date 00:00:01' AND `cart_time`<='$end_date 23:59:59' GROUP BY `order_id` ORDER BY `id` DESC";
	}
	elseif ($select_type=="phone_number") 
	{
		$sql_search="SELECT `order_id`, `brand`, `branch`, `phone`, `order_status`, `agent`, `order_status`, `address`, `additional_phone`, `cart_time`,`last_update_time` FROM `order` WHERE `phone`='$search_key' AND `cart_time`>='$start_date 00:00:01' AND `cart_time`<='$end_date 23:59:59' GROUP BY `order_id` ORDER BY `id` DESC";
	}
	elseif ($select_type=="status") 
	{
		$sql_search="SELECT `order_id`, `brand`, `branch`, `phone`, `order_status`, `agent`, `order_status`, `address`, `additional_phone`, `cart_time`,`last_update_time` FROM `order` WHERE `order_status`='$search_key' AND `cart_time`>='$start_date 00:00:01' AND `cart_time`<='$end_date 23:59:59' GROUP BY `order_id` ORDER BY `id` DESC";
	}
	...
	<div class="mt-3">
		...
		<div style="overflow-x: scroll;">
			<table class="table table-hover table-bordered p-2" style="font-size: 11px; width: 100%;">
				<thead>
					<th>SL</th>
					<th>Order ID</th>
					<th>Brand</th>
