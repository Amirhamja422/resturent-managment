...
$previous_billing_result=mysql_query("SELECT * FROM `restaurant`.`billing_address` WHERE `phone`='$phone' ORDER BY id DESC");
$count_billing_data=mysql_num_rows($previous_billing_result);
	...
	<div class="row m-3 p-3">
		...
		<div class="col-md-12 border-top border-bottom pb-1 pt-1 text-right mt-2">
			...
			<div class="col-md-4 float-left pt-1 p-0">
				<input type="hidden" name="sub_total" id="sub_total" value="<?php echo  $sub_total;?>" readonly>
				...
				<div class="col-md-3 float-right">
					<p class="h6 float-left">
						<div class="from-group">
							<input type="number" style="width: 64px;" value="0" name="discount" id="discount" class="from-control" onchange="calculate_discount()">
							<script>
		...
		<div class="col-md-12 mt-2">
			...
			// if ($count_billing_data>0) 
			// {
			// 	$billing_data=mysql_fetch_assoc($previous_billing_result);
				?>
		<!-- 	// 	<div class="form-group">
			// 		<input type="text" class="form-control" name="customer_name" id="customer_name"  placeholder="Enter Customer Name" value="<?php echo $billing_data['name']; ?>">
			// 	</div>
			// 	<div class="form-group">
			// 		<textarea class="form-control" id="address" rows="3" placeholder="Enter Customer Delivery Address"><?php echo $billing_data['address']; ?></textarea>
			// 	</div>
			// 	<div class="text-danger m-1" id="address_error"></div>
			// 	<div class="form-group">
			// 		<input type="number" class="form-control" id="additional_phone" value="<?php echo $billing_data['additional_phone']; ?>" placeholder="Enter Additional Phone Number">
			// 	</div> -->
			<?php
			// }
			// else
			// {
				...
				<div class="form-group">
					<textarea class="form-control" id="address" rows="3" placeholder="Enter Customer Delivery Address"><?php echo $row_crm_data['address']; ?></textarea>
				</div>
				<div class="text-danger m-1" id="address_error"></div>
				<div class="form-group">
					<input type="number" class="form-control" id="additional_phone" value="<?php echo $row_crm_data['other_phone']; ?>" placeholder="Enter Additional Phone Number">
				</div>
				<?php
			// }
			?>
